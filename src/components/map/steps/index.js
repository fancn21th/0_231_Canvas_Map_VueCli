 ...
 *
    ...
    案例b:
      ...
      [
        ['ID', '层级', '市', '县', '名字', '经度', '纬度']
        ['166', '省直帮扶点', '十堰市', '丹江口市', '蒿坪村', '111.270590', '32.751992']
        ['167', '市级帮扶点', '十堰市', '张湾区', '文武沟村', '110.586426', '32.744052']
      ]
      expected:
      [
        [
          ['name', 'geo', '项目数', '总金额'],
          ['蒿坪村', ['111.270590', '32.751992'], '16', '900.00'],
          ['文武沟村', ['111.270590', '32.751992'], '13', '700.00'],
        ],
        ... // 多个系列
      ]
 *
